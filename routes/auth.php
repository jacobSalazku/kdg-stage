...
Route::group(['prefix' => LaravelLocalization::setLocale()], function () {
    Route::middleware('guest')->group(function () {
        ...
        Route::get(LaravelLocalization::transRoute('routes.forgot'), [PasswordResetLinkController::class, 'create'])
            ->name('password.request');

        Route::post(LaravelLocalization::transRoute('routes.forgot'), [PasswordResetLinkController::class, 'store'])
            ->name('password.email');

        Route::get(LaravelLocalization::transRoute('routes.reset-token'), [NewPasswordController::class, 'create'])
            ->name('password.reset');

        Route::post(LaravelLocalization::transRoute('routes.reset'), [NewPasswordController::class, 'store'])
            ->name('password.store');
    });
